...
Folder naming context: this is a shared model-resource folder (`PathogenicMetabolicNetworkModels`) used across multiple figure/table analyses, rather than a single figure-specific output folder.
