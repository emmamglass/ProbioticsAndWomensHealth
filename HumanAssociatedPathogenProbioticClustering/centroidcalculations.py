...
classification_order = ["Commensal", "Pathogen", "Probiotic"]
...
scatter = sns.scatterplot(data=df, x="Component 1", y="Component 2", hue=classification_col, palette=palette, alpha=0.6, edgecolor='black')
