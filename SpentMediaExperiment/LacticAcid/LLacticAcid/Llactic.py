...
inhibitory_llac   = [7.0245, 15.138, 7.689, 16.263]
moderate_llac    = [11.790, 7.159, 7.128, 6.144]
uninhibitory_llac  = [7.176, 7.528, 7.566,  1.453]

# 2. Group labels and data in order
order = ['Uninhibitory', 'Moderate', 'Inhibitory']
data  = {
    'Inhibitory':    inhibitory_llac,
    'Moderate':          moderate_llac,
    'Uninhibitory':  uninhibitory_llac
}
...
ax.set_ylabel('L-lactic acid concentration (mmol/L)', fontsize=12)
